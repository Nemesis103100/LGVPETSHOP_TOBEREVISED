...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Users</h3>
	</div>
	<div class="card-body">
		<form action="" id="product-form">
			...
			<div class="form-group">
                ...
                <input name="firstname" id="" cols="30" class="form-control form no-resize" value="<?php echo isset($firstname) ? $firstname : ''; ?>">
            </div>
            <div class="form-group">
                <label for="lastname" class="control-label">Last Name</label>
                <input name="lastname" id="" cols="30" class="form-control form no-resize" value="<?php echo isset($lastname) ? $lastname : ''; ?>">
            </div>
            <div class="form-group">
                <label for="username" class="control-label">Username</label>
                <input name="username" id="" cols="30" class="form-control form no-resize" value="<?php echo isset($username) ? $username : ''; ?>">
            </div>
            <div class="form-group">
                <label for="password" class="control-label">Password</label>
                <input type="password" name="password" id="" cols="30" class="form-control form no-resize" value="">
            </div>
