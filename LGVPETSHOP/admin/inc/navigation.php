...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand" style="background-color: #343a40;">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>admin" class="brand-link bg- text-sm" style="background-color: #7BD1F9;">
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=transaction_history" class="nav-link nav-transaction_history">
                        <i class="nav-icon fas fa-list"></i>
                        <p>
                          Transaction History
                        </p>
                    ...
                    <!-- <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=new_page" class="nav-link nav-system_info">
                        <i class="nav-icon fas fa-cogs"></i>
                        <p>
                          TEST
                        </p>
