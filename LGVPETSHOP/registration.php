...
<div class="container-fluid">
    ...
    <h3 class="text-left text-dark">Create New Account</h3>
            <hr>
        ...
        <div class="row  align-items-center h-100">
            ...
            <div class="col-lg-5 border-right">
                ...
                <div class="form-group">
                    <label for="" class="control-label text-dark">Firstname</label>
                    <input type="text" class="form-control form-control-sm form" name="firstname" required>
                </div>
                <div class="form-group">
                    <label for="" class="control-label text-dark">Lastname</label>
            ...
            <div class="col-lg-7">
                <div class="form-group">
                    <label for="" class="control-label text-dark">Default Delivery Address</label>
