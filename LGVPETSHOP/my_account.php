        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="w-100 justify-content-between d-flex">
                    <h4><b>Orders</b></h4>
                    <a style="background-color: #FFE57C;" href="./?p=edit_account" class="btn btn btn-flat"><div class="fa fa-user-cog"></div> Manage Account</a>
                </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="javascript:void(0)" class="view_order" data-id="<?php echo $row['id'] ?>">Check Order</a></td>
