        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="w-100 justify-content-between d-flex">
                    ...
                    <a style="background-color: #FFE57C;" href="./?p=my_account" class="btn btn btn-flat"><div class="fa fa-angle-left"></div> Back to Order List</a>
                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0" max="11" maxlength="11" class="form-control form-control-sm form" name="contact" required>
                    ...
                    <script>
                        document.querySelectorAll('input[type="number"]').forEach(input =>{
                            ...
                            <div class="form-group d-flex justify-content-end">
                                <button style="background-color: #FFE57C;" class="btn btn-flat">Update</button>
                            </div>
                        </form>
                    </div>
            </div>
