    ...
    <div class="container">
        <div class="card rounded-0">
            ...
            <form action="" id="place_order">
                ...
                <input type="hidden" name="payment_method" class="payment_method" value="gcash">
                <input type="hidden" name="transaction_id" class="transaction_id" value="<?php echo uniqid(10); ?>">
                    ...
                    <div class="col-6">
                        ...
                        <h4 class="text-muted">Payment Method</h4>
                            <div class="d-flex w-100 justify-content-between">
                                <select class="btn btn-flat border text-left paymentmethod d-none">
                                   
                                    <!-- <option value="cod">COD</option> -->
                                    <option value="gcash">GCASH</option>
                                </select>
                                <button style="background-color: #FFE57C;" class="btn btn-flat submit">GCASH</button>
                ...
                if(!!resp.status && resp.status == 'success'){
                    ...
                    setTimeout(function(){
                        if ($('.paymentmethod').val() == 'cod') {
                            ...
                            location.replace('./?p=gcash&transaction_id='+$('.transaction_id').val())
                        }
