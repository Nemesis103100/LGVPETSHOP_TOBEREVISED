    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-end mb-2">
                <button style="background-color: #FFE57C;" class="btn btn-outline-dark btn-flat btn-sm" type="button" id="empty_cart">Empty Cart</button>
            </div>
        </div>
                ...
                ?>
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <img src="<?php echo validate_image($img) ?>" loading="lazy" class="cart-prod-img mr-2 mr-sm-2 border" width="200" height="350" alt="">
                            <div>
        ...
        <div class="d-flex w-100 justify-content-end">
            <a style="background-color: #FFE57C;" href="./?p=checkout" class="btn btn-sm btn-flat ">Checkout</a>
        </div>
    </div>
</section>
<script>
